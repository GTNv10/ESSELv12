...
function createFilterUI(filter, index, handleRowSelectionCb, handleCellUpdateCb) {
    ...
    if (filter.column) {
        ...
        if (format === 'date' || (() => {
            ...
            conditionSelect.innerHTML = `<option value=">=" ${filter.condition === '>=' ? 'selected' : ''}>&gt;=</option><option value="<=" ${filter.condition === '<=' ? 'selected' : ''}>&lt;=</option><option value=">" ${filter.condition === '>' ? 'selected' : ''}>&gt;</option><option value="<" ${filter.condition === '<' ? 'selected' : ''}>&lt;</option><option value="=" ${filter.condition === '=' ? 'selected' : ''}>=</option>`;
        } else {
